...
% Function that evaluates the initial pressure p and spool displacement kappa in 
% the system
%
...
% Residual evaluation
    ...
    % Here we are using the initial effective force provided by the mechanical system
